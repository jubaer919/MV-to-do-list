...
To Do List! project is a repository consisting of the following files:
- HTML file 
- CSS file 
- JS files
...
## To Do List - [HTML/CSS & JavaScript To Do List project](https://github.com/microverseinc/curriculum-javascript/blob/main/books/m2_plain_js_classes_v1_1.md)
### Features Added:
- Create a collection of task
- Create a function to add a new task to the collection, with task name bulian and a button
- Create a function to remove a task from the collection 
...
To Do List: a complete website [this](https://github.com/microverseinc/curriculum-javascript/blob/main/books/m4_full_website_v1_1.md) will be added.
